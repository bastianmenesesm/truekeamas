  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24, padding: 20, background: 'var(--sf)', borderRadius: 14, border: '1.5px solid var(--ln)' }}>
        <div style={{ width: 60, height: 60, borderRadius: 16, background: 'linear-gradient(135deg,var(--v),var(--vl))', display: 'grid', placeItems: 'center', color: '#fff', fontFamily: 'Syne,sans-serif', fontSize: 26, fontWeight: 900 }}>{name.charAt(0).toUpperCase()}</div>
        <div>
